...
| onSelected   | `function` | Callback which called when all dates will be selected depends on `selectedType` `function ({ selected?: Date | null, selectedStart?: Date | null, selectedEnd?: Date | null, })`| -       |
