...
| :----------------------------- | :---------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------- |
| onDayPress                     | `function (date: Date)` | Callback which called when day pres                                                                                                                                                                           | -           |
...
| Prop         | Type                                                                                             | Description                                                                     | Default |
| :----------- | :----------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------ | :------ |
| selectedType | `'single',range','single-range'`                                                                 | The type of picker                                                              | -       |
| onSelected   | `function ({ selected?: Date | null, selectedStart?: Date | null, selectedEnd?: Date | null, })` | Callback which called when all dates will be selected depends on `selectedType` | -       |
